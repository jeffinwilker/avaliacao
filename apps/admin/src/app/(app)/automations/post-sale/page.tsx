  ...
  const [settingsResult, ordersResult, postPurchaseResult, reviewsResult] =
    await Promise.all([
      admin
        .from("store_settings")
        .select(
          `whatsapp_enabled, request_delay_days, whatsapp_template,
  ...
  return (
    <div className="space-y-6 p-5 md:p-8">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-600">
            Crie as mensagens, escolha quando enviar e acompanhe as avaliações recebidas.
          </p>
        </div>
      ...
      <PostSaleDashboard
        ...
        initialReviewDelayDays={settings?.request_delay_days ?? 7}
        ...
        initialPostPurchaseDelayHours={settings?.post_purchase_delay_hours ?? 24}
  ...
  return (
    <div className="p-8">
      ...
      <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 p-5 text-amber-900">
        ...
        migration <code className="font-mono">0006_whatsapp_automations.sql</code>{" "}
